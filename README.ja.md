...
4. `expo-router-navigation` と `expo-ui-system` で画面構成と UI を整えます。
...
8. リリース前に `expo-store-console-setup`、`expo-store-review-info`、`expo-android-jks-signing`、`expo-eas-build-strategy`、`expo-version-ota-governance`、`expo-fastlane-automation`、`expo-release-review` を使います。
