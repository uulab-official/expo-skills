...
8. 스토어 출시 전 `expo-store-console-setup`, `expo-store-review-info`, `expo-android-jks-signing`, `expo-eas-build-strategy`, `expo-version-ota-governance`, `expo-fastlane-automation`, `expo-release-review`를 사용합니다.
